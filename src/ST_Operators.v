...
Module Type ST_OPERATORS.
  ...
  Parameter is_inst : type -> bool.
  Parameter get_pou_name : type -> option ident.
  Parameter implicit_cast : type -> type -> Prop .
  (* Booleans *)
  ...
  Parameter sem_val_cast : val -> type -> type -> option val.
  ...
  Axiom wt_val_const : 
  forall c , 
  wt_val (sem_const c) (type_const c).
...
Module Type OPERATORS_AUX (Import Ops : ST_OPERATORS).
...
Module OperatorsAux (Import Ops : ST_OPERATORS) <: OPERATORS_AUX Ops.
